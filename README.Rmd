...
In general, to order and format DESCRIPTION fields according to a fixed standard,
run 
```{r}
...
The following command adds an issue to your repo with a checklist of tasks to complete before submitting to CRAN:
```{r}
